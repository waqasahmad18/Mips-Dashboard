      ...
      <div className="mt-4 pb-2">
            <div className="flex flex-nowrap items-center justify-between gap-2">
              ...
              <button
                ...
                className={`w-[10.1rem] cursor-pointer rounded-2xl border-2 border-white/25 bg-gradient-to-br from-[#d97706] to-[#ea580c] px-4 py-4 text-left text-white shadow-[0_10px_22px_rgba(234,88,12,0.4)] transition ${selectedCategory === "pi" ? "scale-[1.03] border-white outline outline-4 outline-amber-200/90 ring-4 ring-white/55 shadow-[inset_0_0_0_2px_rgba(255,255,255,0.65),0_0_0_2px_rgba(245,158,11,0.5),0_14px_24px_rgba(234,88,12,0.55)]" : "opacity-90 hover:scale-[1.01] hover:border-white/50 hover:opacity-100"}`}
              >
                <div className="mb-3 inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/50 bg-white/30 text-white backdrop-blur-sm shadow-[0_0_20px_rgba(255,255,255,0.3)]">
